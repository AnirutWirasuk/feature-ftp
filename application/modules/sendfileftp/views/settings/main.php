      ...
      <div class="ibox float-e-margins">
          <div class="ibox-content">
              ...
              <form action="<?=site_url('administrator/settings/update')?>" method="post" enctype="multipart/form-data" name="formSettings" id="formSettings" class="form-horizontal" novalidate>
                ...
                <div class="hr-line-dashed"></div> -->
                <div class="form-group"><label class="col-sm-2 control-label">Line Id</label>
                    <div class="col-sm-10"><input type="text" name="Text_Idline" id="Text_Idline" placeholder="" value="<?=$Text_Idline;?>" class="form-control"></div>
                </div>
                <div class="hr-line-dashed"></div>
